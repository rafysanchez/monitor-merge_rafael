...
{
    public class IndicadoresMonitoramentoRepository : EFRepository<IndicadoresMonitoramento>, IIndicadoresMonitoramentoRepository
    {
        public IndicadoresMonitoramentoRepository(IUnitOfWork uow) : base(uow)
        {
        }
    }
}
