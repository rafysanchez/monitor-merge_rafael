...
namespace Castle.DynamicLinqQueryBuilder
{
    ...
    public static class QueryBuilder
    {
        ...
        /// <param name="indexedPropertyName">The indexable property to use</param>
        /// <returns>Filtered IQueryable</returns>
        public static Expression<Func<T, bool>> BuildQueryExpression<T>(FilterRule filterRule, bool useIndexedProperty = false, string indexedPropertyName = null)
        {            
            return BuildExpression<T>(filterRule, useIndexedProperty, indexedPropertyName);
        }
        /// <summary>
        /// Gets the filtered collection after applying the provided filter rules.
        /// </summary>
        ...
        /// <returns></returns>
        public static Expression<Func<T, bool>> BuildExpression<T>(FilterRule filterRule, bool useIndexedProperty = false, string indexedPropertyName = null)
        {
            if (filterRule == null)
            {
                //parsedQuery = "";
            ...
            //parsedQuery = expressionTree.ToString();
            var expression = Expression.Lambda<Func<T, bool>>(expressionTree, pe);
            //var whereCallExpression = Expression.Call(
            //    typeof(Queryable),
            //    "Where",
            //    new[] { typeof(T) },                
        ...
        public static LambdaExpression BuildOrderBy<T>(string sortColumn)
        {
