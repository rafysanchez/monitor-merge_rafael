...
{
    public class ProgramaSaude : BaseModel
    {
        public virtual int IdPrograma { get; set; } 
        public virtual string NmPrograma { get; set; } 
        ...
        {
            var other = obj as ProgramaSaude;
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
             return IdPrograma == other.IdPrograma;
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
              return $"{this.IdPrograma}".GetHashCode();
            }
        }
